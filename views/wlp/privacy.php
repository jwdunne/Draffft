...
<div class="body-wrapper clr">
    <section class="grid-full">
        <article class="article-overview-wrapper">
            <div class="article-copy-preview clr">
                <h1>Privacy Policy</h1>
                <h3>Introduction</h3>
                <p>weloveprogramming.org ("we" or "us") values its visitors' privacy. This privacy policy is effective 14FEB2013; it summarizes what information we might collect from a registered user or other visitor ("you"), and what we will and will not do with it.</p>
                <p>Please note that this privacy policy does not govern the collection and use of information by companies that weloveprogramming.org does not control, nor by individuals not employed or managed by weloveprogramming.org. If you visit a Web site that we mention or link to, be sure to review its privacy policy before providing the site with information.</p>
                ...
                <ul>
                    ...
                    <li>your weloveprogramming.org user ID and password</li>
                ...
                <ul>
                    ...
                    <ul>
                        ...
                        <li>as necessary to protect the rights, safety, or property of weloveprogramming.org, its users, or others; this may include (for example) exchanging information with other organizations for fraud protection and/or risk reduction.</li>
                    </ul>
                </ul>
                ...
                <ul>
                    ...
                    <li>to log off the weloveprogramming.org Web site when you are finished;</li>
                ...
                <p>If you have questions or comments about weloveprogramming.org's privacy policy, send an email to info@devxdev.com, or contact us via any of the ways described in the <a href="http://weloveprogramming.org/draffft/contact-us">Contact Us</a> page.</p>
                <p>Thank you for choosing weloveprogramming.org!</p>
            </div>
        </article>
    </section>
</div>
